// /**
//  * NOTA PARA BACKEND:
//  * Este archivo será eliminado. Se deja solo como referencia de la
//  * lógica 
//  * Ya conecté el Dashboard con un fetch, 
//  * pero como quizás aún no tienen listos los cálculos de
//  * Engagement Rate o la agrupación por meses para el gráfico,
//  * les dejé este archivo de referencia donde yo ya resolví las 
//  * consultas de Prisma y las fórmulas matemáticas.
//  * Pueden copiar tal cual las queries de agregación 
//  * (_sum, _avg, groupBy) para su controlador de Node.
//  * 
//  * 
//  * Necesito un solo endpoint GET /dashboard/stats que me devuelva
