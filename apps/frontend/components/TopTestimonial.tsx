...
const TopTestimonial = ({ data} : { data: TopTestimonial[] }) => {
  return (
   <div className="space-y-6">
        ...
        {/* Grid que muestra los testimonios más vistos*/}
        <div className="grid grid-cols-1 md:grid-cols-1 gap-6">
            ...
            data.map((t, index) => (
                ...
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <div>
                            <p className="text-xs text-txtSecondary truncate w-32">{t.content}</p>
                        </div>
            ...
            <p className="text-sm text-muted text-center py-4">No hay datos aún</p>
            )}
        </div>
    </div>
  )
