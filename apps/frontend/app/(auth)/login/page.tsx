      ...
      <div className="hidden lg:flex flex-col items-center justify-center bg-dark rounded-l-4xl p-12 text-txtPrimary">
        <div className="max-w-sm text-center">
          ...
          <p className="text-txtPrimary text-lg">
            Gestiona, modera y distribuye testimonios de tu institución desde un
            solo lugar.
          </p>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <MdEmail
                  className={`absolute left-4 top-1/2 -translate-y-1/2 text-xl ${errors.email ? "text-red-500" : "text-txtSecondary"}`}
                />
                <input
                  {...register("email")}
                  type="email"
                  ...
                  className={`w-full pl-12 pr-4 py-3.5 bg-dark rounded-xl border-2 transition-all outline-none ${
                    errors.email
                      ...
                      : "border-transparent focus:border-primary shadow-sm"
                  }`}
                />
              </div>
              {errors.email && (
                <p className="flex items-center gap-2 text-red-500 text-xs font-bold ml-1">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <MdLock
                  className={`absolute left-4 top-1/2 -translate-y-1/2 text-xl ${errors.password ? "text-red-500" : "text-medium"}`}
                />
                <input
                  {...register("password")}
                  type="password"
